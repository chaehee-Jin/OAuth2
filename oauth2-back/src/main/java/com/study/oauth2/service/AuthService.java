...
//		authorities.add(new SimpleGrantedAuthority("ROLE_USER"));
	...
	public int oAuth2Register(OAuth2RegisterReqDto oAuth2RegisterReqDto) {
		...
		return userRepository.saveAuthority(Authority.builder().userId(userEntity.getUserId()).roleId(1).build());
	}
	...
	public int oAuth2ProviderMerge(OAuth2ProviderMergeReqDto oAuthProviderMergeReqDto) {
		User userEntity = userRepository.findUserByEmail(oAuthProviderMergeReqDto.getEmail());

		String provider = oAuthProviderMergeReqDto.getProvider();
